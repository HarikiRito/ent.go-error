...
func (c *TestClient) UpdateOneID(id uint64) *TestUpdateOne {
...
func (c *TestClient) DeleteOneID(id uint64) *TestDeleteOne {
...
func (c *TestClient) Get(ctx context.Context, id uint64) (*Test, error) {
	return c.Query().Where(test.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *TestClient) GetX(ctx context.Context, id uint64) *Test {
