...
func (tq *TestQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (tq *TestQuery) FirstIDX(ctx context.Context) uint64 {
...
func (tq *TestQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (tq *TestQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (tq *TestQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (tq *TestQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
